            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <div class="my-auto">{{ __('Create Education') }}</div>
                        <a href="/resume/{{ request()->id }}" class="btn btn-primary btn-sm" type="button">Back</a>
                    </div>
                </div>

                <div class="card-body">
                    {!! Form::open(['url' => 'education/store', 'method'=>'POST', 'class'=>'', 'files' => true]) !!}
                    ...
                    <div class="row mx-0 py-2">
                        <div class="col-12 col-lg-6">
                            <div class="mb-3">
                                <label>School</label>
                                {!! Form::text('school', '', ['class'=>'form-control '.Helper::errorForm($errors, 'school')['class'], 'placeholder'=>'Ex: Universiti Teknologi MARA (UiTM) ']) !!}
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="mb-3">
                                <label>Degree</label>
                                {!! Form::text('degree', '', ['class'=>'form-control '.Helper::errorForm($errors, 'degree')['class'], 'placeholder'=>'Ex: DIPLOMA IN COMPUTER SCIENCE']) !!}
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="mb-3">
                                <label>Grade</label>
                                {!! Form::number('grade', '', ['class'=>'form-control '.Helper::errorForm($errors, 'grade')['class'], 'placeholder'=>'Ex: 3.50', 'step'=>'.01']) !!}
