...
class ResumeUpdateDTO extends Data
{
    ...
    {
        return [
            'unique_link' => 'nullable|string|unique:resumes,unique_link,' . request()->id,
            'title' => 'required|string|unique:resumes,title,' . request()->id,
            'name' => 'required|string|bail',
            'phone' => 'required|string|bail',
            'email' => 'required|email|bail',
            'avatar' => 'nullable|image|mimes:png,jpg,jpeg|max:2048|bail',
